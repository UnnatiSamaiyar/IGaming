          ...
          <div className="flex h-full space-x-6">
            {FEATURES.map((feature, i) => (
              <div 
                ...
                className="flex-shrink-0 w-72 bg-gray-800 rounded-xl p-6 flex flex-col border border-gray-700"
              >
...
export default SleekFeatureShowcase;
