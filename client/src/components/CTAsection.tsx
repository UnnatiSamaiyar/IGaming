    ...
    <div className="relative overflow-hidden bg-gray-900 rounded-2xl px-8 py-12 shadow-xl">
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <button className="group relative flex items-center justify-center px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/30">
            Explore Regulations
